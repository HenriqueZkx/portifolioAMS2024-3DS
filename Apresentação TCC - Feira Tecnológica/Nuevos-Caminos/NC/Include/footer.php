                  ...
                  <div class="wow slideInDown" data-wow-delay="0s">
                    ...
                    <article class="post post-minimal-2">
                      <p class="post-minimal-2-title">
                        <a href="public/src/empreabilidad.php"
                ...
                <div class="oh-desktop">
                  <div class="wow slideInLeft" data-wow-delay="0s">
                    ...
                    <ul
                      ...
                      <li><a href="public/sobre.php">Sobre nosotros</a></li>
                      <li><a href="public/forum/">Foro</a></li>
                    </ul>
                    <div class="group-md group-middle justify-content-sm-start">
                      <a class="button button-lg button-primary button-ujarak" href="public/sobre.php">Saber más</a>
                    </div>
                  </div>
                </div>
              </div>
